...
:
    resolve =
>
    require(["../views/article/Article.vue"], resolve)
}
,
{
    path: "/archives",
...
:
    resolve =
>
    require(["../views/album/Album.vue"], resolve),
        meta
:
    {
        title: "相册"
...
:
    resolve =
>
    require(["../views/album/Photo.vue"], resolve)
}
,
{
    path: "/tags",
...
:
    resolve =
>
    require(["../views/tag/Tag.vue"], resolve),
        meta
:
    {
        title: "标签"
...
:
    resolve =
>
    require(["../views/link/Link.vue"], resolve),
        meta
:
    {
        title: "友链列表"
...
:
    resolve =
>
    require(["../components/OauthLogin.vue"], resolve)
}
,
{
