<template>
    <el-card class="main-card">
        ...
        <div class="article-status-menu">
            <span>状态</span>
            <span :class="isActive('all')" @click="changeStauts('all')">全部</span>
            <span :class="isActive('public')" @click="changeStauts('public')">
        公开
      </span>
            <span :class="isActive('secret')" @click="changeStauts('secret')">
        私密
      </span>
            <span :class="isActive('draft')" @click="changeStauts('draft')">
        草稿箱
      </span>
            <span :class="isActive('delete')" @click="changeStauts('delete')">
        回收站
      </span>
        </div>
        <!-- 表格操作 -->
